...
class SlAuthWidget extends StatefulWidget {
  ...
  final bool? isGoogleEnable;

  ///speficy if twitter is enable
  final bool? isTwitterEnable;

  ///specify if apple is enable
  final bool? isAppleEnable;

  ///specify is facebook is enable
  final bool? isFacebookEnable;

  ///Twitter api key
  final String? twitterApiKey;

  ///Tweitter secret keys
  final String? twitterSecrectKey;

  ///Twitter redirct url
  final String? twitterRedirctUrl;
